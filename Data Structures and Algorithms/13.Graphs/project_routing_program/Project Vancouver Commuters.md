...
22. Outside of both loops but still inside the `get_route()` function, we can now get our shortest route from our `routes` list based on list length using a nifty Python trick:
